<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master"
    AutoEventWireup="true" CodeFile="MasterChemist.aspx.cs" Inherits="WebPages_ItemCategory" %>
                ...
                <div runat="server" id="divAddItems" visible="false">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="Label7" runat="server" CssClass="LabelStyles" Text="Chemist Name : "></asp:Label>
                            <asp:TextBox TabIndex="1" runat="server" ID="txtChemistName" CssClass="form-control TextBox"
                            ...
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                Enabled="True" TargetControlID="txtChemistName" ValidChars=" .',()-/">
                            </cc1:FilteredTextBoxExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtChemistName"
                                CssClass="LabelStyleRequired" ErrorMessage="Enter Chemist Name" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-4">
                            ...
                            <cc1:FilteredTextBoxExtender ID="txtMobile_FilteredTextBoxExtender" runat="server"
                                Enabled="True" FilterType="Custom,Numbers" TargetControlID="txtMobile" ValidChars="-">
                            </cc1:FilteredTextBoxExtender>
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox TabIndex="1" runat="server" ID="txtNumber" CssClass="form-control TextBox"
                                placeholder="Other Contact Numbe" />
                ...
                <div id="divViewItem" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="Label12" runat="server" CssClass="LabelStyles" Text="Chemist Name : "></asp:Label>
                            <asp:TextBox TabIndex="1" runat="server" ID="txtSrchChemistName" CssClass="form-control TextBox"
                                placeholder="Chemist Name" />
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                Enabled="True" TargetControlID="txtSrchChemistName" ValidChars=" .',()-/">
                            </cc1:FilteredTextBoxExtender>
                                ...
                                <asp:GridView ID="gvDoctorDetail" runat="server" AutoGenerateColumns="False" CssClass="Admingridtable"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" ToolTip="Edit" CausesValidation="false"
                                                    runat="server" CommandArgument='<%# Eval("Che_Mid") + "," + Eval("Che_Name") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Category MID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatMID" runat="server" Text='<%# Eval("Che_Mid") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Chemist Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDoctorname" runat="server" Text='<%# Eval("Che_Name") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Address">
                                            <ItemTemplate>
                                                <asp:TextBox TabIndex="1" runat="server" ID="txtAAddress" Enabled="false" CssClass="form-control TextBox"
                                                    Text='<%# Eval("Che_Address") %>' TextMode="MultiLine" />
                                            </ItemTemplate>

                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Location">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDoctorLoc" runat="server" Text='<%# Eval("Che_Location") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Contact Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMeasuringUnit" runat="server" Text='<%# Eval("Che_ContactNo") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDel" CausesValidation="false" ToolTip="Delete" runat="server"
                                                    CommandArgument='<%# Eval("Che_Mid") + "," + Eval("Che_Name") %>' CommandName="btnDelete"> <i class="fa fa-trash" style="color:Red;font-size:1.5em;" onclick="return confirm('Are you sure want to delete? ');"></i></asp:LinkButton>
