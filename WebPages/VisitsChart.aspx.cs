...
public partial class WebPages_VisitsChart : System.Web.UI.Page
{
    ...
    private void FnUGCourseSGoogleCHartBind(DataTable DT)
    {
        ...
        // Set chart options
        Script += " var options = { 'title': 'Location Wise Visits'};";
    ...
    {
        string qry = " select [Trans_Location],COUNT([Trans_Mid]) as cnt from [dbo].[tbl_Transaction] where [Trans_AF]=1 and [Trans_RepMid]='" + ddlMedRep.SelectedValue + "'";
