<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master" AutoEventWireup="true" CodeFile="MedicalRepVisitChart.aspx.cs" Inherits="WebPages_VisitsChart" %>
    ...
    <div class="container-fluid" width="100%" style="font-size: 14px; background-color: white">
        ...
        <div class="row">
            <div class="col-md-12" align="center">
                <h2>Medical Rep Wise Visits Report</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
