<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master" AutoEventWireup="true" CodeFile="MedicalRepsVisitReport.aspx.cs" Inherits="WebPages_StockOutReport" %>
                    ...
                    <div runat="server" id="divSearch">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-4">
                                        <asp:Label ID="Label7" runat="server" CssClass="LabelStyles" Text="Doctor/ Chemist/Stockiest  Name : "></asp:Label>

                                        <asp:TextBox TabIndex="1" runat="server" ID="txtDoctor" CssClass="form-control TextBox"
                                            placeholder="Doctor / Chemist" />
                            ...
                            <asp:GridView ID="gvStockOutReport" runat="server" AutoGenerateColumns="False" CssClass="Admingridtable"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Visited">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSource2" runat="server" Text='<%# Eval("DOCCHESTNAME")%>'
                                                Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
