<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master" AutoEventWireup="true" CodeFile="BranchMaster.aspx.cs" Inherits="WebPages_BranchMaster" %>
            ...
            <div class="col-md-10">
                <div runat="server" id="divAddItems" visible="false">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" runat="server" id="divDoctor">
                            ...
                            <asp:Label ID="Label6" runat="server" CssClass="LabelStyles" Text="RSM : "></asp:Label>
                            <asp:DropDownList ID="ddlRSM" CssClass="form-control TextBox" runat="server"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlRSM"
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox TabIndex="1" runat="server" ID="txtBranchName" CssClass="form-control TextBox"
                            ...
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                Enabled="True" TargetControlID="txtBranchName" ValidChars=" .',()-/">
                            </cc1:FilteredTextBoxExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBranchName"
                                CssClass="LabelStyleRequired" ErrorMessage="Enter Branch Name" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                    <div class="col-md-4">
                        <asp:Label ID="Label4" runat="server" CssClass="LabelStyleValidation" Font-Bold="True"
                            Text="*" ForeColor="red"></asp:Label>
                        <asp:Label ID="Label5" runat="server" CssClass="LabelStyles" Text="Branch Description : "></asp:Label>
                        <asp:TextBox TabIndex="1" runat="server" ID="txtBranchDescription" CssClass="form-control TextBox" TextMode="MultiLine"
                            placeholder="Branch Description" />

                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBranchDescription"
                            CssClass="LabelStyleRequired" ErrorMessage="Enter Branch Description" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>
                ...
                <div id="divViewItem" runat="server">
                    ...
                    <div class="row">
                            ...
                            <asp:Label ID="Label9" runat="server" CssClass="LabelStyles" Text="RSM : "></asp:Label>
                            <asp:DropDownList ID="ddlRSMSrch" CssClass="form-control TextBox" runat="server"></asp:DropDownList>
                          
                        </div>
                        <div class="col-md-4">

                            <asp:Label ID="Label12" runat="server" CssClass="LabelStyles" Text="Branch Name : "></asp:Label>
                            <asp:TextBox TabIndex="1" runat="server" ID="txtSrchBranchName" CssClass="form-control TextBox"
                                placeholder="Branch Name" />
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                Enabled="True" TargetControlID="txtSrchBranchName" ValidChars=" .',()-/">
                            </cc1:FilteredTextBoxExtender>
                    ...
                    <div class="row">
                        <div class="col-md-12" align="center" style="overflow-x: scroll">
                            <div>
                                <asp:GridView ID="gvBranchDetail" runat="server" AutoGenerateColumns="False" CssClass="Admingridtable"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" ToolTip="Edit" CausesValidation="false"
                                                    runat="server" CommandArgument='<%# Eval("Branch_Mid") + "," + Eval("Branch_Name") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Category MID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatMID" runat="server" Text='<%# Eval("Branch_Mid") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Branch Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblusername" runat="server" Text='<%# Eval("Branch_Name") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                                <asp:TemplateField HeaderText="RSM">
                                            <ItemTemplate>
                                                <asp:Label ID="lblusername1" runat="server" Text='<%# Eval("RSM_Name") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Branch Description">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRole" runat="server" Text='<%# Eval("Branch_Description") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDel" CausesValidation="false" ToolTip="Delete" runat="server"
                                                    CommandArgument='<%# Eval("Branch_Mid") + "," + Eval("Branch_Name") %>' CommandName="btnDelete"> <i class="fa fa-trash" style="color:Red;font-size:1.5em;" onclick="return confirm('Are you sure want to delete? ');"></i></asp:LinkButton>
