<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePublic.master"
    AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" MaintainScrollPositionOnPostback="true"
            ...
            <div class="col-md-8" align="center">
                <div align="center" style="border: 1px inset #960e00; width: 75%; border-radius: 4px 4px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8" align="center">
                            <asp:Label ID="Label3" runat="server" Font-Bold="true" CssClass="LabelStyleValidation"
                                Text="*" ForeColor="red"></asp:Label>
                            <asp:RadioButtonList ID="rbdType" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem>&nbsp Admin Or Branch Manager &nbsp</asp:ListItem>
                                <asp:ListItem>&nbsp RSM &nbsp</asp:ListItem>                              
                            </asp:RadioButtonList>


                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ErrorMessage="Select Type"
                                ControlToValidate="rbdType" runat="server" ForeColor="Red" />
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
