<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master"
    AutoEventWireup="true" CodeFile="StockiestMaster.aspx.cs" Inherits="WebPages_ItemCategory" %>
                ...
                <div runat="server" id="divAddItems" visible="false">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="Label7" runat="server" CssClass="LabelStyles" Text="Stockiest Name : "></asp:Label>
                            <asp:TextBox TabIndex="1" runat="server" ID="txtStockiestName" CssClass="form-control TextBox"
                                placeholder="Stockiest Name" />
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                Enabled="True" TargetControlID="txtStockiestName" ValidChars=" .',()-/">
                            </cc1:FilteredTextBoxExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtStockiestName"
                                CssClass="LabelStyleRequired" ErrorMessage="Enter Stockiest Name" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-4">
                ...
                <div id="divViewItem" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="Label12" runat="server" CssClass="LabelStyles" Text="Stockiest Name : "></asp:Label>
                            <asp:TextBox TabIndex="1" runat="server" ID="txtSrchStockiestame" CssClass="form-control TextBox"
                                placeholder="Stockiest Name" />
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                Enabled="True" TargetControlID="txtSrchStockiestame" ValidChars=" .',()-/">
                            </cc1:FilteredTextBoxExtender>
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox TabIndex="1"  MaxLength="12"  runat="server" ID="txtSrchNumber" CssClass="form-control TextBox"
                    ...
                    <div class="row">
                        ...
                        <%-- <div class="col-md-8" runat="server" visible="false">
                            ...
                            <asp:Label ID="Label18" runat="server" CssClass="LabelStyles" Text="Branch : "></asp:Label>
                                <asp:DropDownList ID="ddlBranch" runat="server" CssClass="form-control TextBox"></asp:DropDownList>
                        ...
                        <div class="col-md-8">
                            ...
                            <asp:Label ID="Label13" runat="server" CssClass="LabelStyles" Text="Location : "></asp:Label>
                    ...
                    <div class="row">
                        <div class="col-md-12" align="center" style="overflow-x: scroll">
                            <div>
                                <asp:GridView ID="gvStockiestDetail" runat="server" AutoGenerateColumns="False" CssClass="Admingridtable"
                                    EmptyDataText="No Records Found!!!" Width="100%" EnableModelValidation="True"
                                    OnRowCommand="gvStockiestDetail_RowCommand" OnRowDataBound="gvStockiestDetail_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" ToolTip="Edit" CausesValidation="false"
                                                    runat="server" CommandArgument='<%# Eval("ST_Mid") + "," + Eval("ST_Name") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Category MID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatMID" runat="server" Text='<%# Eval("ST_Mid") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Doctor Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDoctorname" runat="server" Text='<%# Eval("ST_Name") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Address">
                                            <ItemTemplate>
                                                <asp:TextBox TabIndex="1" runat="server" ID="txtAAddress" Enabled="false" CssClass="form-control TextBox"
                                                    Text='<%# Eval("ST_Address") %>' TextMode="MultiLine" />
                                            </ItemTemplate>

                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Location">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDoctorLoc" runat="server" Text='<%# Eval("Branch_Name") %>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="150px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Contact Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMeasuringUnit" runat="server" Text='<%# Eval("ST_ContactNumber") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDel" CausesValidation="false" ToolTip="Delete" runat="server"
                                                    CommandArgument='<%# Eval("ST_Mid") + "," + Eval("ST_Name") %>' CommandName="btnDelete"> <i class="fa fa-trash" style="color:Red;font-size:1.5em;" onclick="return confirm('Are you sure want to delete? ');"></i></asp:LinkButton>
