<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master" AutoEventWireup="true" CodeFile="AdminVisitReport.aspx.cs" Inherits="WebPages_AdminVisitReport" %>
    ...
    <div class="container-fluid" width="50%" style="background-color: White">
        ...
        <div class="row">
            <div class="col-md-12" align="center">
                <h2>Medical Reps Visit Report</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div runat="server" id="divStockIn">
                    <div runat="server" id="divSearch">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-4">
                                        <asp:Label ID="Label7" runat="server" CssClass="LabelStyles" Text="Doctor / Chemist  Name : "></asp:Label>
                    ...
                    <div class="row" runat="server" id="View">
                        <div class="col-md-12" align="center">
                            <asp:Label ID="lblHeading" Visible="False" runat="server" Font-Bold="True" Text="Medical Reps Visit Report" Font-Size="Large"></asp:Label>
                        </div>
                        <div class="col-md-12" style="overflow-x: scroll">
                            <asp:GridView ID="gvAdminVisitReport" runat="server" AutoGenerateColumns="False" CssClass="Admingridtable"
                                EmptyDataText="No Records Found!!!" Width="100%" EnableModelValidation="True" OnRowCommand="gvAdminVisitReport_RowCommand" OnRowDataBound="gvAdminVisitReport_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Visited">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSource" runat="server" Text='<%# Eval("DOCCHESTNAME")%>'
                                                Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Meet Chemist?">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSource1" runat="server" Text='<%# Eval("Trans_ChemistMeet")%>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                        </ItemTemplate>
                                        <ControlStyle Width="100px" />
                                    </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Chemist Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQty" runat="server" Text='<%# Eval("ChemName")%>' Style="word-break: break-all; word-wrap: break-word;"></asp:Label>
                                        </ItemTemplate>
                                        <ControlStyle Width="110px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Approve">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatusApr" runat="server" Text='<%# Eval("Trans_Status")%>' Visible="false"></asp:Label>
                                            <asp:LinkButton ID="lnkApprove" CausesValidation="false" ToolTip="Approve" runat="server"
                                                CommandArgument='<%# Eval("Trans_Mid")%>' CommandName="btnApprv"> <i class="fa fa-check" style="font-size:1.5em;color:Green" onclick="return confirm('Are you sure want to Approve? ');"></i></asp:LinkButton>
                                        </ItemTemplate>
                                        <ControlStyle Width="100px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Reject">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatusRej" runat="server" Text='<%# Eval("Trans_Status")%>' Visible="false"></asp:Label>
                                            <asp:LinkButton ID="lnkReject" CausesValidation="false" ToolTip="Reject" runat="server"
                                                CommandArgument='<%# Eval("Trans_Mid") %>' CommandName="btnReject"> <i class="fa fa-close" style="font-size:1.5em;color:red" onclick="return confirm('Are you sure want to Reject? ');"></i></asp:LinkButton>
                                        </ItemTemplate>
                                        <ControlStyle Width="100px" />
                                    </asp:TemplateField>
            ...
            $("#<% =txtItem.ClientID %>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "../Items.ashx?q=" + document.getElementById('<% =txtItem.ClientID %>').value,
                        dataType: "json",
