<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPagePrivate.master" AutoEventWireup="true" CodeFile="MedicalRepVisitTest.aspx.cs" Inherits="WebPages_MedicalRepVisitTest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    ...
    <div class="container-fluid" width="50%" style="background-color: White">
        ...
        <div class="row">
            <div class="col-md-12" align="center">
                <button type="button" class="find-me">Find My Location</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <asp:Label ID="Label23" runat="server" CssClass="LabelStyleValidation" Font-Bold="True"
                                        Text="*" ForeColor="red"></asp:Label>
                                    <asp:Label ID="Label7" runat="server" CssClass="LabelStyles" Text="Select Doctor/Chemist/Stockiest"></asp:Label>
                    ...
                    <div class="row" runat="server" id="divMedDetails1" visible="false">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txtMedicine" runat="server" ForeColor="Black" CssClass="form-control TextBox"
                                MaxLength="10" TabIndex="12" placeholder="Medicine" OnTextChanged="txtMedicine_TextChanged" AutoPostBack="True"></asp:TextBox>
                            <cc1:FilteredTextBoxExtender ID="txtMobile_FilteredTextBoxExtender" runat="server"
                                Enabled="True" FilterType="Custom,Numbers,LowercaseLetters,UppercaseLetters" TargetControlID="txtMedicine">
                            </cc1:FilteredTextBoxExtender>

                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtMedicine"
                                CssClass="LabelStyleValidation" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter Medicine" ValidationGroup="Add"></asp:RequiredFieldValidator>
